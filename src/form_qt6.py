...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.wordFieldComboBox
        )
        ...
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.definitionFieldComboBox
        )
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.ItemRole.FieldRole, self.exampleFieldComboBox
        )
        self.label_4 = QtWidgets.QLabel(Dialog)
        self.label_4.setObjectName("label_4")
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_4
        )
        self.genderFieldComboBox = QtWidgets.QComboBox(Dialog)
        self.genderFieldComboBox.setObjectName("genderFieldComboBox")
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.genderFieldComboBox
        )
        self.label_5 = QtWidgets.QLabel(Dialog)
        self.label_5.setObjectName("label_5")
        self.formLayout.setWidget(
            6, QtWidgets.QFormLayout.ItemRole.LabelRole, self.label_5
        )
        self.POSFieldComboBox = QtWidgets.QComboBox(Dialog)
        self.POSFieldComboBox.setObjectName("POSFieldComboBox")
        self.formLayout.setWidget(
            6, QtWidgets.QFormLayout.ItemRole.FieldRole, self.POSFieldComboBox
        )
        self.addButton = QtWidgets.QPushButton(Dialog)
        self.addButton.setObjectName("addButton")
        self.formLayout.setWidget(
            7, QtWidgets.QFormLayout.ItemRole.FieldRole, self.addButton
        )
        ...
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.dictionaryComboBox
        )
