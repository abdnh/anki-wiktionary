...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.exampleFieldComboBox)
        self.addButton = QtWidgets.QPushButton(Dialog)
        self.addButton.setObjectName("addButton")
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.addButton)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.genderFieldComboBox)
        self.POSFieldComboBox = QtWidgets.QComboBox(Dialog)
        self.POSFieldComboBox.setObjectName("POSFieldComboBox")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.POSFieldComboBox)
