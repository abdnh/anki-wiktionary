...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.chooseFileButton)
        self.dictionaryComboBox = QtWidgets.QComboBox(Dialog)
        self.dictionaryComboBox.setObjectName("dictionaryComboBox")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.dictionaryComboBox)
        self.addButton = QtWidgets.QPushButton(Dialog)
        self.addButton.setObjectName("addButton")
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.addButton)
        ...
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.dictionaryNameLineEdit)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.SpanningRole, self.description)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.filenameLabel)
